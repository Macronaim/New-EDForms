...
class GF_Field_Website extends GF_Field {
	...
	public function validate( $value, $form ) {
		...
		if ( ! empty( $value ) && ! GFCommon::is_valid_url( $value ) ) {
			$this->failed_validation  = true;
			$this->validation_message = empty( $this->errorMessage ) ? esc_html__( 'Please enter a valid Website URL (e.g. http://www.edconcept24.fr).', 'gravityforms' ) : $this->errorMessage;
		}
	}
