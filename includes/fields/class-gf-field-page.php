...
class GF_Field_Page extends GF_Field {
	...
	public function get_form_editor_field_title() {
		return esc_attr__( 'Page', 'edforms' );
	}
	...
	public function get_field_content( $value, $force_frontend_label, $form ) {
		...
		$field_content = "{$admin_buttons} <label class='gfield_label'>&nbsp;</label><div class='gf-pagebreak-inline gf-pagebreak-container'><div class='gf-pagebreak-text-before'>" . esc_html__( 'end of page', 'edforms' ) . "</div><div class='gf-pagebreak-text-main'><span>" . esc_html__( 'PAGE BREAK', 'edforms' ) . "</span></div><div class='gf-pagebreak-text-after'>" . esc_html__( 'top of new page', 'edforms' ) . '</div></div>';
