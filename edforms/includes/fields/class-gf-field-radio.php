...
class GF_Field_Radio extends GF_Field {
	...
	public function get_form_editor_field_title() {
		return esc_attr__( 'Radio Buttons', 'edforms' );
	}
		...
		if ( is_array( $this->choices ) ) {
			...
			foreach ( $this->choices as $choice ) {
				...
				if ( rgar( $choice, 'isOtherChoice' ) ) {
					...
					$label = "<input id='input_{$this->formId}_{$this->id}_other' name='input_{$this->id}_other' type='text' value='" . esc_attr( $other_value ) . "' aria-label='" . esc_attr__( 'Other', 'edforms' ) . "' onfocus='$onfocus' onblur='$onblur' $tabindex $onkeyup $disabled_text />";
				}
