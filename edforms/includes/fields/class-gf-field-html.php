...
class GF_Field_HTML extends GF_Field {
	...
	public function get_form_editor_field_title() {
		return esc_attr__( 'HTML', 'edforms' );
	}
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		$content = $is_entry_detail || $is_form_editor ? "<div class='gf-html-container'><span class='gf_blockheader'>
															<i class='fa fa-code fa-lg'></i> " . esc_html__( 'HTML Content', 'edforms' ) .
															'</span><span>' . esc_html__( 'This is a content placeholder. HTML content is not displayed in the form admin. Preview this form to view the content.', 'edforms' ) . '</span></div>'
														: $this->content;
